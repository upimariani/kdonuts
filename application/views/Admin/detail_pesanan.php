                                ...
                                <div class="col-md-4">
                                    <div class="full invoice_blog padding_infor_info padding-bottom_0">
                                        ...
                                        <p><strong><?= $detail['transaksi']->nama_lengkap ?></strong><br>
                                            ...
                                            <?= $detail['transaksi']->desa_kel ?><br>
                                            <strong>Phone : </strong><a href="tel:9876543210"><?= $detail['transaksi']->no_hp ?></a><br>
                                            <strong>Email : </strong><a href="mailto:yourmail@gmail.com"><?= $detail['transaksi']->email ?></a>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-4">
